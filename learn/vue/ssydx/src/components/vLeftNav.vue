...
const navLeftData = defineProps({
    navImg: {
        type: String,
        default: `<svg viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg">
...
<template>
<div class="leftNav">
    <div class="homebrand" v-html="navLeftData.navImg"></div>
</div>
</template>
