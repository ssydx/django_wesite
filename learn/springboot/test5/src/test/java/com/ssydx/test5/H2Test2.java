...
public class H2Test2 {
    ...
    public void testAuthorDao() {
        Long id = authorDao.addAuthor(new AuthorEntity().setName("张三").setAge(Byte.valueOf("25")));
        authorDao.queryAll().forEach(System.out::println);
        authorDao.updateAuthor(new AuthorEntity(id, "李四", Byte.valueOf("35")));
        System.out.println(authorDao.queryById(id));
